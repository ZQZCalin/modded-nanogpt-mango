# Standard NanoGPT training pipeline,
# refactored for better configuration and modules.
...
def str2bool(arg):
    """Parsing string argument 'True/False' from cmd into booleans."""
...
def parse_args():
    ...
    parser.add_argument("--dataset.data_dir", dest="data_dir", type=str,
                        default="data",
                        help="Dataset: raw data path.")
    parser.add_argument("--dataset.train_files", dest="train_files", type=str,
                        default="fineweb10B/fineweb_train_*.bin",
                        help="Dataset: input .bin to train on.")
    parser.add_argument("--dataset.val_files", dest="val_files", type=str,
                        default="fineweb10B/fineweb_val_*.bin",
                        help="Dataset: input .bin to eval validation loss on.")
    parser.add_argument("--dataset.val_tokens", dest="val_tokens", type=int,
                        default=10485760,
                        help="Dataset: how many tokens of validation data? it's important to keep this fixed for consistent comparisons.")
    parser.add_argument("--dataset.train_seq_len", dest="train_seq_len", type=int,
                        default=48*1024,
                        help="Dataset: FlexAttention sequence length.")
    parser.add_argument("--dataset.val_seq_len", dest="val_seq_len", type=int,
                        default=4*64*1024,
                        help="Dataset: FlexAttention sequence length for validation.")
    # architecture
    parser.add_argument("--model.vocab_size", dest="vocab_size", type=int,
                        default=50257,
                        help="Model: tokenizer vocabulary size.")
    # training
    parser.add_argument("--train.seed", dest="seed", type=int, 
                        default=42,
                        help="Training: global random seed of the entire experiment.")
    parser.add_argument("--train.total_steps", dest="total_steps", type=int,
                        default=1770,
    ...
    parser.add_argument("--checkpoint.load_file", dest="load_file", type=str,
                        help="Checkpoint: loaded checkpoint file name.")
    # others
    parser.add_argument("--system.compile_only", dest="compile_only", type=str2bool, default=False, 
